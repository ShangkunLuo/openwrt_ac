...
VERSION_NUMBER:=$(if $(VERSION_NUMBER),$(VERSION_NUMBER),1.05.15)

VERSION_CODE:=$(call qstrip_escape,$(CONFIG_VERSION_NUMBER))
VERSION_CODE:=$(if $(VERSION_CODE),$(VERSION_CODE),1.05.15)
...
VERSION_DIST:=$(if $(VERSION_DIST),$(VERSION_DIST),SZTozed)
...
VERSION_PRODUCT:=$(if $(VERSION_PRODUCT),$(VERSION_PRODUCT),PF-AC-300)
